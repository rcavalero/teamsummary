...
const welcome = [
    { type: "input", message: "Team Summary - Enter Manager's Info then add Team Members. (press enter key to continue)", name: "proceed" },
];
const empQuestions = [
...
const engQuestion = [
    { type: "input", message: "Enter Engineer's GitHub username", name: "username" },
];
const intQuestion = [
    { type: "input", message: "Where did Intern go to school?", name: "school" },
];
